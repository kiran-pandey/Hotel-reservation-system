	...
	if(isset($_POST['book'])){
		...
		if(count($err)==0){
             require "connection.php";
                 $sql="insert into fullreservation(f_name,l_name,number,email,bookedby,checkindate,checkoutdate,roomtype,cus_id) values ('$fname','$lname','$number','$email','$bookedby','$check_in','$check_out','Suite','$user_id')";
               $connect->query($sql);
...
<div class="card">
    ...
    <div class="form-group col-md-4">
		...
		<input type="text" name="type" id="type" class="form-control" value="Suite" disabled>
		</div>
		<div class="form-group col-md-4">
		<label for="price">Price</label>
		<input type="number" name="price" id="price" class="form-control" value="3000" disabled>
		</div>
</div>
<div class="form-row">
    <div class="form-group col-md-4">
